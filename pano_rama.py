...
class Stitch:
	...
	def warpTwoImages(self, img2, img1, H):
		...
		# cv2.waitKey()
		cv2.imwrite('g.jpg',result[t[1]:t[1]+h1,:])
		# cv2.waitKey()
		print("hi ",img1.shape,result[t[1]:t[1]+h1,:].shape)
		output = self.Laplacian_Pyramid_Blending_with_mask(result[t[1]:t[1]+h1,:],img1, 6)
...
if __name__ == '__main__':
	...
	print(("done"))
	cv2.imwrite("fg"+str(s.count)+".jpg", s.leftImage)
	print( "image written")
