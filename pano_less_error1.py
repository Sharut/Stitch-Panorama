...
class Stitch:
	...
	def warpTwoImages(self, img2, img1, H):
		...
		# warped img2
		result = cv2.warpPerspective(img2, Ht.dot(H), dsize=(a,b))		# jan do blending here somewhere! ! ! ! !
...
if __name__ == '__main__':
	...
	print(("done"))
	cv2.imwrite("ltor_100k_hq_sir1_"+str(s.count)+".jpg", s.leftImage)
	print( "image written")
